...
export const ThemeUI = {
	...
	Select: ({
		...
		const customSelectStyles = {
			...
			// Menu is rendered into a portal (document.body by default) so it always paints
			// above sibling rows/cards/modals instead of being clipped or overlapped by
			// later DOM content (e.g. the next row in an invoice items table).
			menuPortal: (base) => ({
				...base,
				zIndex: 9999,
			}),
